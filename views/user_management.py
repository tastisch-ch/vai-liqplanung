...
# Cookie Manager für persistente Anmeldung NACH st.set_page_config() initialisieren
# Dies ist wichtig, da der Cookie-Manager Streamlit-Komponenten verwendet
import extra_streamlit_components as stx
try:
    cookie_manager = stx.CookieManager(key="auth_cookies")
    # Cookie-Manager ist jetzt für andere Module verfügbar
    st.session_state["cookie_manager"] = cookie_manager
except Exception as e:
    st.error(f"Fehler beim Initialisieren des Cookie-Managers: {e}")
